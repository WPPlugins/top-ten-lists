	...
	class TopTenListsPlugin
	{
		...
		public function adminScripts($hook)
		{
			...
			if (in_array($screen->id, array('post', 'page'))) {
				...
				wp_register_script('top_ten_lists_admin_js', plugin_dir_url(__FILE__) . 'assets/build/admin.js', array('angular'));
		...
		{
			add_meta_box('top-ten-lists-plugin', '<span class="dashicons dashicons-editor-ol"></span> Top Ten Lists', array($this, 'listFields'), 'post', 'advanced', 'high');
		}
